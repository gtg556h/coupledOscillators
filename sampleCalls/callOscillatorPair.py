...
c0 = oscillatorLib.oscillator(x1, y1, dt, t, staticRate0, leakRate, randomStd, peakEpsilon, epsilon_floor, APLength, contractionDelay, peakForce, c_initial, peakCouplingRate0, sensitivityWinParam, title)

c1 = oscillatorLib.oscillator(x2, y2, dt, t, staticRate1, leakRate, randomStd, peakEpsilon, epsilon_floor, APLength, contractionDelay, peakForce, c_initial, peakCouplingRate1, sensitivityWinParam, title)
...
u0 = oscillatorLib.oscillator(x1, y1, dt, t, staticRate0, leakRate, randomStd, peakEpsilon, epsilon_floor, APLength, contractionDelay, peakForce, c_initial, peakCouplingRate0, sensitivityWinParam, title)

u1 = oscillatorLib.oscillator(x2, y2, dt, t, staticRate1, leakRate, randomStd, peakEpsilon, epsilon_floor, APLength, contractionDelay, peakForce, c_initial, peakCouplingRate1, sensitivityWinParam, title)
...
if 1:
    ...
    oscillatorLib.plotOscillatorPair(c0, c1, u0, u1, f1, f2, title)
