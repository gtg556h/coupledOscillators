...
filename = "nonleaky_phaseDependent_manyOscillators_lowPhaseSensitivity"
...
peakEpsilon = 1
epsilon_floor = 0.8
APLength = 0.2  # measured from contractions on 20160516.  This is the visible part only...
contractionDelay = 0.005  # pretty random i suppose
peakForce = 1
peakCouplingRate = 12/(nCells-1)
c_initial0 = 0.7
c_initial1 = 0
...
staticRate = (0.95 + 0.1*numpy.random.rand(nCells)) * staticRate
